class Product {
  ...
  final String? route;
  final double? weight;
  final double? pos_production_time;
  final double? customer_lead_time;
  final double? depreciation_time;
  final double? depreciation_value_rate;
  final double? multi_quantity_rate;
  final String? queue_type;
  final double? manufacture_time;
